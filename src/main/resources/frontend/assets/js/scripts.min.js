        ...
        var Card = function () {
            var bookTemplate = function (book) {
                return '<div class="Card">' + '   <div class="Card-picture">' + '<a href="' + book.slug + '">' + '       <img src="' + book.image + '">\n' + '</a>' +
                    ...
                    '<div class="Card-cost">' +
                    (book.discount > 0 ? '<span class="Card-priceOld">$' + (book.price/100) + '</span>\n' : '') +
                    '<span class="Card-price">$' + (book.discount==0 ? book.price/100 : book.discountPrice) + '</span>\n' + ' </div>\n' + '</div>\n' + '</div>';
            }
            return {
                init: function () {
                    $('[data-refreshshow]').on('click change', function (e) {
                            ...
                            $.ajax({
                                ...
                                complete: function (result) {
                                    if (result.status === 200) {
                                        ...
                                        if(result.responseJSON.count > 0) $this.data('refreshoffset', $this.data('refreshoffset') + 1);
                                        var $Cards = $('.Cards_refresh');
                                        if (type === 'changedate') {
                                            $Cards.find('.Card').remove();
                                        }
                        ...
                        switch (data) {
                                ...
                                if (e.type === 'change') {
                                    ...
                                    if (!$this.hasClass('form-input_date_uninit')) {
                                        ...
                                        $refreshoffset.each(function () {
                                            var $this = $(this);
                                            $this.data('refreshoffset', /*$this.data('refreshlimit')*/1);
                                        });
                                    }
                                }
                                break;
                            case'recent':
                                ...
                                break;
                            case'popular':
                                getData('/books/popularpage', {
                                    offset: $this.data('refreshoffset'),
                                    limit: $this.data('refreshlimit')
                                });
                                break;
                            case'genre':
                                getData('/books/genresbookspage' /*+ $this.data('refreshid')*/, {
                                    genreSlug: window.location.pathname.match(/\/([^\/]+)$/)[1],
                                    offset: $this.data('refreshoffset'),
                                    limit: $this.data('refreshlimit')
                                });
                                break;
                            case'author':
                                getData('/books/authorbookspage' /*+ $this.data('refreshid')*/, {
                                    authorSlug: window.location.pathname.match(/\/([^\/]+)$/)[1],
                                    offset: $this.data('refreshoffset'),
                                    limit: $this.data('refreshlimit')
                                });
                                break;
                            case'tag':
                                ...
                                getData('/books/taggedbookspage' /*+ $this.data('refreshid')*/, {
                                    tag: tagValue,
                                    offset: $this.data('refreshoffset'),
                                    limit: $this.data('refreshlimit')
                                });
                            ...
                            $this.on('afterChange', function (e, slick) {
                                if ($(slick.$slides[slick.$slides.length - 3]).hasClass('slick-active')) {
                                    if ($(slick.$slider).data('load')) {
                                        ...
                                        function sendData(address, parameters) {
                                            getData(address, {
                                                ...parameters,
                                        ...
                                        switch ($(slick.$slider).data('load')) {
                                            case'recommended':
                                                ...
                                                break;
                                            case'recent':
                                                sendData('/books/recentpage')
                                                break;
                                            case'popular':
                                                sendData('/books/popularpage')
                                                break;
                                            case'author':
                                                sendData('/books/authorbookspage', {authorSlug: window.location.pathname.match(/\/([^\/]+)$/)[1]})
                                                break;
                                        }
                                    }
                                }
